...
description: Reference and guide for Unreal Engine C++ development, including UE APIs, gameplay systems, async tasks, networking, GAS, Enhanced Input, and build diagnostics.
---
...
- **不包含课程实际源代码** — 需配合课程工程使用，代码路径以 `Courses/UE-CPP-Basic-to-Advanced/code/` 为根
...
关键代码文件：[ch3/ 目录](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/knowledge/ch3/)
...
| 类/宏 | 文件路径 | 职责 |
|-------|---------|------|
| FString | [XGSampleString.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/010_String/XGSampleString.h) | 可变字符串，Printf/Format/Parse 操作 |
...
| 类 | 文件路径 | 职责 |
|----|---------|------|
| UGameInstanceSubsystem | [016_Subsystem/XGSimpleSubsystem.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/016_Subsystem/XGSimpleSubsystem.h) | GameInstance 生命周期 |
| UWorldSubsystem | [016_Subsystem/XGSimpleSubsystem.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/016_Subsystem/XGSimpleSubsystem.h) | World 生命周期 |
| UDeveloperSettings | [018_Config/XGSampleSettings.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/018_Config/XGSampleSettings.h) | 配置读取 |

### 多线程

| 类 | 文件路径 | 职责 |
|----|---------|------|
| FRunnable + FRunnableThread | [020_Thread/XGSimpleRunnable.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/020_Thread/XGSimpleRunnable.h) | 独立线程任务 |
| Async() + TFuture | [020_Thread/XGThreadSubsystem.cpp](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/020_Thread/XGThreadSubsystem.cpp) | TaskGraph 异步 |
| FGraphEvent + FFunctionGraphTask | [020_Thread/XGThreadSubsystem.cpp](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/020_Thread/XGThreadSubsystem.cpp) | 任务 DAG |
| ParallelFor | 引擎内置 | 数据并行 @Line 336 |
| FControlFlow | [021_ControlFlows/XGControlFlowsSubsystem.cpp](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/021_ControlFlows/XGControlFlowsSubsystem.cpp) | 异步步骤编排 |

### 智能指针

| 类 | 文件路径 | 职责 |
|----|---------|------|
| TSharedPtr | [019_SmartPointer/XGSampleSharedPointer.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/019_SmartPointer/XGSampleSharedPointer.h) | 共享所有权，引用计数 |
| TSharedRef | 同上 | 非空共享引用，隐式转 TSharedPtr |
| TUniquePtr | 同上 | 独占所有权，MoveTemp 转移 |
| TWeakPtr | 同上 | 弱引用，Pin() 提升语义 |
| TSharedFromThis | [XGSamplePointerHelper.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/019_SmartPointer/XGSamplePointerHelper.h) | 安全获取自身 TSharedPtr |

### 日志与调试

| 类/宏 | 文件路径 | 职责 |
|-------|---------|------|
| UE_LOG | [015_Log/XGLogTest.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/015_Log/XGLogTest.h) | 七级 Verbosity 日志输出 |
| DECLARE_LOG_CATEGORY_EXTERN | 同上 | 日志分类声明 |
| UE_LOGFMT | 同上 | 结构化日志语法 |
| check / verify / ensure | [017_Assert/XGAssertTest.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/017_Assert/XGAssertTest.h) | 三种断言机制对比 |
...
| 类 | 文件路径 | 职责 |
|----|---------|------|
| FHttpModule + FHttpRequest | [025_HttpTime/XGSampleHttpTime.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/025_HttpTime/XGSampleHttpTime.h) | HTTP 客户端 |
| FHttpServerModule | XGSampleServer（独立程序） | HTTP 服务端 |
| FWebSocketsModule + IWebSocket | [XGSampleXFLink/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Plugins/XGSampleLink/Source/XGSampleXFLink/) | WebSocket 客户端 |
| IWebSocketServer + FWebSocket | [XGSampleWSM/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Plugins/XGSampleWSM/) | WebSocket 服务端 |
| FSocket + FTcpSocketBuilder | [XGSampleEMail/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Plugins/XGSampleEMail/) | TCP 客户端（SMTP 邮件） |
| UBlueprintAsyncActionBase | [XGSampleEMail/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Plugins/XGSampleEMail/) | 异步行动基类 |

### 网络同步

| 类/宏 | 文件路径 | 职责 |
|-------|---------|------|
| ENetRole / GetLocalRole / GetRemoteRole | [XGNetBase.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/016_XGNetDemo/Source/XGNetDemo/XGNetBase.h) | 网络角色判定（Authority/AutonomousProxy/SimulatedProxy） |
...
| 类 | 文件路径 | 职责 |
|----|---------|------|
| FSimpleUIApp | [XGSlateSample/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/013_独立程序源码/XGSlateSample/) | Slate 主窗口管理 |
| SCompoundWidget 派生 | [XGSlateSample/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/013_独立程序源码/XGSlateSample/) | 自定义 Slate 控件 |
| INT32_MAIN_ENTRY | [XGBlankProgram/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/013_独立程序源码/XGBlankProgram/) | 独立程序入口点 |

### GAS

| 类 | 文件路径 | 职责 |
|----|---------|------|
| UAbilitySystemComponent | [XGRPG/AbilitySystem/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/017_XGRPG/XGRPG/Source/XGRPG/AbilitySystem/) | 能力系统组件 |
| UAttributeSet | [XGRPG/AbilitySystem/Attributes/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/017_XGRPG/XGRPG/Source/XGRPG/AbilitySystem/Attributes/) | 属性集（2 层继承） |
| UGameplayEffect | [XGRPG/AbilitySystem/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/017_XGRPG/XGRPG/Source/XGRPG/AbilitySystem/) | 游戏效果 |
| UGameplayAbility | [XGRPG/AbilitySystem/Abilities/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/017_XGRPG/XGRPG/Source/XGRPG/AbilitySystem/Abilities/) | 游戏能力 |
| UGameplayEffectExecutionCalculation | [XGRPG/AbilitySystem/Excutions/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/017_XGRPG/XGRPG/Source/XGRPG/AbilitySystem/Excutions/) | 伤害计算公式 |

### 增强输入

| 类 | 文件路径 | 职责 |
|----|---------|------|
| UEnhancedInputLocalPlayerSubsystem | [033_XGGameTemplate/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/033_XGGameTemplate/) | 输入子系统，管理 IMC 注册 |
...
| 类 | 文件路径 | 职责 |
|----|---------|------|
| XGWebPLoader / XGWebPHelper | [XGSampleWebP/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Plugins/XGSampleWebP/) | WebP 编解码 |
| XGXFLink / XGBDLink | [XGSampleLink/](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Plugins/XGSampleLink/) | 第三方 API 封装 |

### GameplayTag 与定时器

| 类 | 文件路径 | 职责 |
|----|---------|------|
| FGameplayTag | [011_TagAndTimer/XGGameplayTagTest.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/011_TagAndTimer/XGGameplayTagTest.h) | 层级标签标识符，支持父子匹配 |
| FGameplayTagContainer | 同上 | 标签容器，支持网络复制 |
| FTimerHandle | [011_TagAndTimer/XGTimerTest.h](file:///d:/UPS/GitLab/XGUnrealNote/Courses/UE-CPP-Basic-to-Advanced/code/001_XGSampleDemo/Source/XGSampleDemo/011_TagAndTimer/XGTimerTest.h) | 定时器句柄 |
